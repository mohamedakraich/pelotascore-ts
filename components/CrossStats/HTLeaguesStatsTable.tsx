...
import { HTLeagueStatsDTO } from "../../types/CrossLeaguesStatsDTO";
...
const convertHTLeagueStatsDTOToData = (stats: HTLeagueStatsDTO[]): Data[] => {
...
interface LeaguesStatsTableProps {
  stats: HTLeagueStatsDTO[];
}

const HTLeaguesStatsTable: React.FC<LeaguesStatsTableProps> = ({ stats }) => {
  const [order, setOrder] = React.useState<Order>("asc");
  const [orderBy, setOrderBy] = React.useState<keyof Data>("league");
  const [selected, setSelected] = React.useState<readonly string[]>([]);

  const statsData = convertHTLeagueStatsDTOToData(stats);
...
export default HTLeaguesStatsTable;
